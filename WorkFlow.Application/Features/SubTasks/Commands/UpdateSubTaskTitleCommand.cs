...
{
    public record UpdateSubTaskTitleCommand(
        Guid SubTaskId,
        string Title
    ) : IRequest<Result>;

    public class UpdateSubTaskTitleCommandValidator : AbstractValidator<UpdateSubTaskTitleCommand>
    {
        public UpdateSubTaskTitleCommandValidator()
        {
    ...
    public class UpdateSubTaskTitleCommandHandler
        : IRequestHandler<UpdateSubTaskTitleCommand, Result>
    {
        ...
        public UpdateSubTaskTitleCommandHandler(
        ...
        public async Task<Result> Handle(UpdateSubTaskTitleCommand request, CancellationToken cancellationToken)
        {
