...
{
    public record ArchiveListCommand(Guid ListId)
    ...
    public class ArchiveListCommandHandler
        : IRequestHandler<ArchiveListCommand, Result<ListDto>>
    {
        ...
        public async Task<Result<ListDto>> Handle(ArchiveListCommand request, CancellationToken cancellationToken)
        {
            ...
            await _realtime.SendToBoardAsync(board.Id, ListEvents.Archived, dto);
