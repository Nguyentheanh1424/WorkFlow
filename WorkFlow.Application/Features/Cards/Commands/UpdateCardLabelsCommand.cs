...
{
    public record UpdateCardLabelsCommand(Guid CardId, int[]? Labels)
        : IRequest<Result<CardDto>>;
    public class UpdateCardLabelsCommandValidator : AbstractValidator<UpdateCardLabelsCommand>
    {
        public UpdateCardLabelsCommandValidator()
        {
    ...
    public class UpdateCardLabelsCommandHandler
        : IRequestHandler<UpdateCardLabelsCommand, Result<CardDto>>
    {
        ...
        public UpdateCardLabelsCommandHandler(
        ...
        public async Task<Result<CardDto>> Handle(UpdateCardLabelsCommand request, CancellationToken cancellationToken)
        {
            ...
            card.UpdateLabels(request.Labels);
            ...
            await _realtime.SendToBoardAsync(board.Id, "BoardNotification", new { Action = CardEvents.Updated, Data = dto });
